...
export const CssIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path
      fill="#ebebeb"
      d="m150.31 268.217 4.07 45.41H256l19.533-22.705L256 268.217zM256 176.305H142.132l4.128 45.411H256l19.533-22.706zm0 257.094 19.533-24.081L256 386.153l-.199.053-50.574-13.656-3.233-36.217h-45.585l6.362 71.301 93.02 25.823z"
      data-original="#ebebeb"
    />
    <path
      d="M160 0h55v23h-32v23h32v23h-55zm66 0h55v20h-32v4h32v46h-55V49h32v-4h-32zm66 0h55v20h-32v4h32v46h-55V49h32v-4h-32z"
      data-original="#000000"
    />
    <path
      fill="#fff"
...
export const ScssIcon = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    viewBox="0  0 500 512"
  ...
  >
    <clipPath id="a">
      <path
        d="M314.44 764.936a48.103 48.103 0 1 1-96.205 0 48.103 48.103 0 1 1 96.206 0z"
        data-original="#000000"
      />
    </clipPath>
    <g transform="translate(0 -952.362)">
      <path
        fill="#2b4896"
        d="M98.266 1002.577c0 26.567-21.537 48.103-48.103 48.103-26.567 0-48.103-21.536-48.103-48.103 0-26.566 21.536-48.102 48.103-48.102 26.566 0 48.103 21.536 48.103 48.102z"
        data-original="#2b4896"
      />
      <rect
        width={58.714}
        height={56.214}
        ...
        fill="#f8f6de"
        clipPath="url(#a)"
        data-original="#f8f6de"
        opacity={0.4}
        ry={6.02}
        transform="translate(-216.175 237.641)"
      />
      <path
        fill="#f8f6de"
        d="M38.938 1015.58c-1.214 0-2.169.285-2.876.844-.706.547-1.062 1.29-1.062 2.25 0 .494.072.904.219 1.25.16.334.39.636.656.875.267.24.577.439.938.625.373.174.778.34 1.218.5.72.267 1.225.524 1.532.75.32.227.5.498.5.844 0 .374-.176.653-.47.813-.293.146-.734.219-1.374.219-.64 0-1.212-.055-1.719-.188a10.64 10.64 0 0 1-1.281-.438l-.438 2.032c.227.093.628.197 1.188.344.56.16 1.298.25 2.218.25 1.374 0 2.423-.244 3.157-.75.746-.52 1.125-1.282 1.125-2.282 0-.466-.068-.885-.188-1.218a2.196 2.196 0 0 0-.562-.875c-.254-.267-.6-.488-1-.688a11.48 11.48 0 0 0-1.438-.656c-.346-.12-.666-.237-.906-.344-.24-.12-.416-.206-.563-.312a1.233 1.233 0 0 1-.312-.407 1.111 1.111 0 0 1-.094-.437c0-.347.162-.621.469-.781.307-.174.694-.25 1.188-.25.546 0 1.024.05 1.437.156.413.093.765.192 1.031.312l.438-1.937a7.379 7.379 0 0 0-1.25-.344c-.56-.12-1.168-.156-1.782-.156zm10.406 0c-.8 0-1.548.127-2.188.407-.64.28-1.171.663-1.625 1.156a5.344 5.344 0 0 0-1.031 1.781c-.24.667-.344 1.383-.344 2.157 0 .786.1 1.507.313 2.187.213.667.542 1.257.968 1.75.44.48.972.845 1.626 1.125.666.267 1.45.407 2.343.407a8.41 8.41 0 0 0 1.657-.157c.546-.106.952-.241 1.218-.375l-.343-2c-.294.12-.632.233-1.032.313-.4.08-.805.125-1.218.125-1.107 0-1.878-.306-2.344-.906-.467-.614-.719-1.43-.719-2.47 0-1.08.257-1.913.75-2.5.493-.6 1.21-.905 2.156-.905.4 0 .779.045 1.125.125.36.08.689.16.969.28l.5-1.968a7.223 7.223 0 0 0-2.781-.531zm8.187 0c-1.213 0-2.168.285-2.875.844-.706.547-1.062 1.29-1.062 2.25 0 .494.072.904.218 1.25.16.334.39.636.657.875.266.24.577.439.937.625.374.174.779.34 1.219.5.72.267 1.225.524 1.531.75.32.227.5.498.5.844 0 .374-.175.653-.468.813-.294.146-.736.219-1.376.219-.64 0-1.212-.055-1.718-.188-.494-.133-.922-.29-1.282-.438l-.437 2.032c.227.093.627.197 1.188.344.56.16 1.298.25 2.218.25 1.374 0 2.423-.244 3.157-.75.746-.52 1.124-1.282 1.124-2.282 0-.466-.067-.885-.187-1.218a2.196 2.196 0 0 0-.563-.875c-.253-.267-.6-.488-1-.688-.4-.213-.864-.443-1.437-.656-.347-.12-.666-.237-.906-.344-.24-.12-.416-.206-.563-.312a1.233 1.233 0 0 1-.312-.407 1.111 1.111 0 0 1-.094-.437c0-.347.162-.621.469-.781.306-.174.694-.25 1.187-.25.547 0 1.024.05 1.438.156.413.093.764.192 1.031.312l.438-1.937a7.379 7.379 0 0 0-1.25-.344c-.56-.12-1.168-.156-1.782-.156zm9.157 0c-1.214 0-2.169.285-2.876.844-.706.547-1.062 1.29-1.062 2.25 0 .494.072.904.219 1.25.16.334.358.636.625.875.266.24.577.439.937.625.374.174.779.34 1.219.5.72.267 1.256.524 1.563.75.32.227.468.498.468.844 0 .374-.144.653-.437.813-.294.146-.767.219-1.406.219-.64 0-1.213-.055-1.72-.188-.493-.133-.92-.29-1.28-.438l-.407 2.032c.227.093.628.197 1.188.344.56.16 1.298.25 2.218.25 1.374 0 2.423-.244 3.157-.75.746-.52 1.125-1.282 1.125-2.282 0-.466-.068-.885-.188-1.218a2.273 2.273 0 0 0-.594-.875c-.253-.267-.568-.488-.968-.688a12.15 12.15 0 0 0-1.469-.656 11 11 0 0 1-.875-.344c-.24-.12-.447-.206-.594-.312a1.233 1.233 0 0 1-.312-.407 1.121 1.121 0 0 1-.063-.437c0-.347.131-.621.438-.781.306-.174.725-.25 1.219-.25.546 0 1.024.05 1.437.156.413.093.733.192 1 .312l.469-1.937a7.913 7.913 0 0 0-1.281-.344c-.56-.12-1.137-.156-1.75-.156zm-35.282 7.782c-.453 0-.85.162-1.156.469a1.48 1.48 0 0 0-.469 1.125c0 .466.162.863.469 1.156.307.293.703.438 1.156.438.44 0 .819-.145 1.125-.438.32-.293.469-.69.469-1.156 0-.467-.149-.832-.469-1.125a1.544 1.544 0 0 0-1.125-.469z"
        data-original="#f8f6de"
      />
    </g>
  </svg>
...
export const BootstrapIcon = (className, ...rest) => (
  ...
  >
    <g fill="#5e3b7f">
      <path
        d="M320.837 285.783c-8.868-8.031-21.082-11.88-36.978-11.88h-92.444v93.365h92.444c15.895 0 28.277-4.099 36.978-12.382 8.784-8.199 13.218-19.911 13.218-34.97 0-14.808-4.35-26.102-13.218-34.133zm-12.717-60.152c8.366-7.195 12.549-17.401 12.549-30.787 0-15.059-3.765-25.684-11.294-31.791s-18.405-9.202-32.628-9.202h-85.333v82.489h85.333c12.55 0 23.007-3.514 31.373-10.709z"
        className="hovered-path"
        data-original="#5e3b7f"
      />
      <path
        d="M426.667 0H85.333C38.4 0 0 38.4 0 85.333v341.333C0 473.6 38.4 512 85.333 512h341.333C473.6 512 512 473.6 512 426.667V85.333C512 38.4 473.6 0 426.667 0zm-46.599 359.488c-4.183 10.206-10.708 18.991-19.66 26.353-8.951 7.362-20.329 13.218-34.3 17.569-13.971 4.35-30.536 6.525-49.778 6.525H139.127V111.268h145.15c26.771 0 48.272 6.107 64.418 18.405s24.261 30.787 24.261 55.634c0 15.059-3.681 27.942-11.043 38.651s-17.903 19.075-31.624 24.931v.837c18.405 3.932 32.377 12.633 41.83 26.102 9.453 13.553 14.222 30.452 14.222 50.865.001 11.712-2.09 22.672-6.273 32.795z"
        className="hovered-path"
        data-original="#5e3b7f"
      />
    </g>
...
export const VscodeIcon = (className , ...rest) => (
  <svg
    ...
    className={`w-full h-14 ${className}`}
  >
    <circle cx={256} cy={256} r={256} fill="#6e64c3" data-original="#6e64c3" />
    <path
      fill="#5046af"
      d="m405.21 129.405-70.646-28.547-124.44 120.581-75.183-57.035-28.518 14.259.366 150.674 180.73 180.73C414.032 494.532 512 386.712 512 256c0-6.947-.287-13.827-.83-20.635l-105.96-105.96z"
      data-original="#5046af"
    />
    <path
      fill="#fff"
      d="m405.21 129.405-70.646-28.547-124.44 120.581-75.183-57.035-28.518 14.259.366 150.674 28.518 14.259 75.183-57.035 124.44 120.581 70.646-28.547-.366-249.19zM142.437 285.913v-63.825L177.718 254h.366l-35.647 31.913zm185.04 21.226L256.549 254h-.366l71.294-53.139v106.278z"
      data-original="#ffffff"
    />
  </svg>
);
...
export const JavaIcon = (className , ...rest) => (
  ...
  >
    ...
    <path
      fill="#73a1fb"
      d="M439.013 456.578a4.192 4.192 0 0 0-4.836.952c-.171.185-17.74 18.556-70.564 29.344-20.223 4.052-58.183 6.107-112.826 6.107-54.745 0-106.838-2.154-107.357-2.176-2.176-.106-4.037 1.476-4.333 3.618a4.197 4.197 0 0 0 3.184 4.658c.542.128 55.135 12.918 129.779 12.918 35.801 0 70.639-2.907 103.548-8.645 61.361-10.757 65.657-41.183 65.81-42.473a4.197 4.197 0 0 0-2.405-4.303z"
      data-original="#73a1fb"
    />
  </svg>
);
...
export const C2Icon = (className , ...rest) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    viewBox="0  0 512 512"
  ...
  >
    <path
      fill="#00599c"
      d="M477.642 383.952c3.569-6.183 5.788-13.15 5.788-19.406V147.389c0-6.256-2.215-13.221-5.786-19.404l-147.4 13.28-101.4 114.703 80.581 114.922 168.217 13.062z"
      data-original="#00599c"
    />
    <path
      fill="#004482"
      d="m275.666 507.243 188.065-108.578c5.417-3.128 10.341-8.529 13.911-14.714L255.968 255.968l-145.887 5.156-75.787 122.829c3.569 6.183 8.495 11.586 13.911 14.712l188.064 108.578c10.834 6.256 28.564 6.256 39.397 0z"
      data-original="#004482"
    />
    <path
      fill="#659ad2"
      d="M477.643 127.983c-3.571-6.185-8.496-11.586-13.912-14.714L275.666 4.692c-10.833-6.256-28.563-6.256-39.397 0L48.205 113.27c-10.835 6.254-19.698 21.609-19.698 34.119v217.157c0 6.256 2.217 13.223 5.788 19.406l221.674-127.984 221.674-127.985z"
      data-original="#659ad2"
    />
    <path
      fill="#fff"
      d="M255.968 407.609c-83.615 0-151.641-68.026-151.641-151.641s68.026-151.641 151.641-151.641c53.954 0 104.274 29.035 131.32 75.773l-65.626 37.976c-13.536-23.394-38.71-37.928-65.693-37.928-41.808 0-75.821 34.012-75.821 75.82 0 41.807 34.012 75.82 75.821 75.82 26.986 0 52.16-14.534 65.698-37.932l65.626 37.974c-27.047 46.743-77.368 75.779-131.325 75.779z"
      data-original="#ffffff"
    />
    <path
      fill="#fff"
      d="M407.609 247.543h-16.85v-16.848h-16.847v16.848h-16.85v16.849h16.85v16.85h16.847v-16.85h16.85zm63.183 0h-16.85v-16.848h-16.847v16.848h-16.85v16.849h16.85v16.85h16.847v-16.85h16.85z"
      data-original="#ffffff"
    />
  </svg>
)
...
export const GitIcon1 = (className , ...rest) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    viewBox="0 0 580 500"
    {...rest}
    className={`w-52 h-66  ${className}`}
  >
    <g data-name="Layer 2">
      <g data-name="76.git">
        <circle cx={76} cy={76} r={76} fill="#f15233" data-original="#f15233" />
        <path
          fill="#fff"
          d="M72 56.44a24.58 24.58 0 0 1-9.12 2c-9-5.26-21.24.22-21.24 11.74 0 4.3 2.71 10.18 6.94 11.62v.2c-3.14 1.4-4 8.58.17 11.16v.17c-4.57 1.52-7.58 4.46-7.58 9.53 0 8.73 8.17 11.16 15.32 11.16 8.71 0 15.19-3.17 15.19-12.89 0-12-16.91-7.55-16.91-14 0-2.29 1.2-3.17 3.29-3.62 7-1.3 11.31-6.78 11.31-13.94a10.27 10.27 0 0 0-.67-3.56A30.91 30.91 0 0 0 72 65zM56.32 98c2.85 0 6.9.51 6.9 4.24s-3.26 4.46-6.31 4.46c-2.9 0-7.25-.46-7.25-4.27S53.36 98 56.32 98zm-.53-22c-3.69 0-5.24-2.2-5.24-5.73 0-8.36 10.21-8.28 10.21-.08 0 3.44-1.34 5.82-5 5.82zm55.04 16.71V84.4a9.06 9.06 0 0 1-4.9 1.41c-3.1 0-3.65-3.06-3.65-5.57V64.79c5.31 0 8.54.17 8.54.17V56.9h-8.54a48.11 48.11 0 0 1 .25-7H93a41.64 41.64 0 0 1 .25 7h-4V65a13.27 13.27 0 0 1 4-.17V65h-.05v14.83c0 7.38 1 14.54 10 14.54a16.13 16.13 0 0 0 7.62-1.66zM80.72 38a6.2 6.2 0 0 0 0 12.37c3.23 0 5.66-3 5.66-6.14S84 38 80.72 38zm-4.67 18.86c.3 2.51.27 33.88 0 37h9.3c-.27-3-.3-34.47 0-36.95z"
          data-original="#ffffff"
        />
      </g>
    </g>
...
export const GitIcon2 = (className , ...rest) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    viewBox="0 0 580 500"
    {...rest}
    className={`w-52 h-66 dark:fill-white  ${className}`}
  >
    <path
...
export const IllustratorIcon = (className , ...rest) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    viewBox="0  0 512 512"
  ...
  >
    <path
      fill="#390000"
      d="M90.667 6.4h330.667C471.467 6.4 512 46.933 512 97.067v317.867c0 50.133-40.533 90.667-90.667 90.667H90.667C40.533 505.6 0 465.067 0 414.933V97.067C0 46.933 40.533 6.4 90.667 6.4z"
      data-original="#390000"
    />
    <path
      fill="#ff9a00"
      d="M248.107 305.92h-79.36l-16.213 50.133c-.427 1.92-2.133 3.2-4.053 2.987h-40.107c-2.347 0-2.987-1.28-2.347-3.84l68.693-197.76c.64-2.133 1.28-4.48 2.133-7.04.853-4.48 1.28-9.173 1.28-13.867-.213-1.067.64-2.133 1.707-2.347h55.253c1.707 0 2.56.64 2.773 1.707l77.867 219.733c.64 2.347 0 3.413-2.133 3.413h-44.587c-1.493.213-2.987-.853-3.413-2.347zm-66.987-43.307h54.187L208 173.653zm181.12-91.946c-7.04.213-13.867-2.56-18.987-7.467-4.907-5.333-7.467-12.373-7.253-19.627-.213-7.253 2.56-14.08 7.68-18.987s11.947-7.467 18.987-7.467c8.32 0 14.72 2.56 19.413 7.467a26.937 26.937 0 0 1 7.04 18.987c.213 7.253-2.347 14.293-7.467 19.627-4.906 5.12-12.16 7.893-19.413 7.467zM338.347 355.84V191.573c0-2.133.853-2.987 2.773-2.987h42.24c1.92 0 2.773 1.067 2.773 2.987V355.84c0 2.347-.853 3.413-2.773 3.413h-41.813c-2.134 0-3.2-1.28-3.2-3.413z"
...
export const IndesignIcon = (className , ...rest) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    viewBox="0 0 580 500"
    {...rest}
    className={`w-32 h-46   ${className}`}
  >
    <g data-name="Photo Surface">
      <rect
        ...
        data-original="#49021f"
        rx={42}
      />
    </g>
    <path
      fill="#f36"
      d="M96 78v104.5c0 1-.45 1.5-1.34 1.5H77.34c-.9 0-1.34-.5-1.34-1.5V78a1.18 1.18 0 0 1 1.34-1.34h17.49c.78 0 1.17.45 1.17 1.34zm51.84 108c-11.61 0-20.54-3.29-27.48-9.86s-10.42-16.28-10.42-29.14q0-17.53 11.19-28.8a40.07 40.07 0 0 1 29.51-12.2 29.62 29.62 0 0 1 7.3.78V72.94a.83.83 0 0 1 .93-.94h18.29c.52 0 .78.31.78.94v94.75c0 4 1.73 7.41 2 10.33a1.26 1.26 0 0 1-.78 1.41c-8.98 4.38-20.75 6.57-31.32 6.57zm10.1-15.49v-48.37c-.65-1.14-4.09-2.14-7.61-2.14a19.61 19.61 0 0 0-15.4 6.85 29.24 29.24 0 0 0-7 19.4c0 8.76 3 14.76 6.92 18.93A19.88 19.88 0 0 0 149.7 172c3.74 0 7.39-.56 8.24-1.49z"
      data-original="#ff3366"
    />
  </svg>
)
...
export const AfterEffectsIcon = (className , ...rest) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
    viewBox="0  0 512 512"
  ...
  >
    <path
      fill="#00005b"
      d="M90.688 6.402h330.746c50.086 0 90.689 40.603 90.689 90.688v317.943c0 50.086-40.603 90.689-90.689 90.689H90.688C40.603 505.721 0 465.119 0 415.033V97.09C0 47.004 40.603 6.402 90.688 6.402z"
      data-original="#00005b"
    />
    <path
      fill="#99f"
      d="M205.735 305.14h-79.361l-16.146 50.254a4.04 4.04 0 0 1-4.123 3.092H65.91c-2.292 0-3.094-1.26-2.405-3.779l68.71-197.067c.687-2.061 1.374-4.076 2.061-6.712.9-4.583 1.36-9.242 1.374-13.913a2.127 2.127 0 0 1 2.405-2.405h54.625c1.599 0 2.516.573 2.749 1.718l77.985 218.722c.687 2.292 0 3.438-2.061 3.436h-44.662a3.174 3.174 0 0 1-3.435-2.405zm-39.853-131.353h-.344l-26.796 88.979h54.281zm233.96 111.793h-67.679a48.265 48.265 0 0 0 6.528 18.928 35.35 35.35 0 0 0 15.631 12.883 65.28 65.28 0 0 0 27.313 5.353 123.779 123.779 0 0 0 22.159-2.433 81.719 81.719 0 0 0 19.052-4.966c1.143-.912 1.718-.343 1.718 1.718V349.7a5.082 5.082 0 0 1-.516 2.577 4.928 4.928 0 0 1-1.546 1.546 87.408 87.408 0 0 1-21.284 6.341 151.004 151.004 0 0 1-30.232 2.577c-16.265 0-29.893-2.519-40.883-7.558a72.873 72.873 0 0 1-26.796-20.269 79.359 79.359 0 0 1-14.773-27.999 110.247 110.247 0 0 1-4.466-31.091 108.277 108.277 0 0 1 5.325-33.839 88.407 88.407 0 0 1 15.975-29.202c15.704-19.028 37.317-26.958 61.495-26.958 20.835 0 42.207 6.9 55.655 23.522a78.138 78.138 0 0 1 12.711 24.22 86.317 86.317 0 0 1 4.123 26.11c0 5.04-.172 9.621-.516 13.742-.343 4.122-.629 7.1-.858 8.932a3.114 3.114 0 0 1-3.092 2.749c-1.374 0-3.722.172-7.042.515-3.323.343-7.445.572-12.367.687-4.932.116-10.138-.722-15.635-.722zm-67.679-31.297h45.005c5.497 0 9.562-.057 12.196-.172a12.01 12.01 0 0 0 4.983-1.651v-2.062a27.467 27.467 0 0 0-1.374-7.901 28.065 28.065 0 0 0-27.827-19.582 29.842 29.842 0 0 0-28.343 16.146 49.627 49.627 0 0 0-4.64 15.222z"
      data-original="#9999ff"
    />
  </svg>
)
...
export const FigmaIcon = (className , ...rest) => (
  ...
  >
    <path
      fill="#00bcff"
      d="M256.599 256c0-47.128 38.205-85.333 85.333-85.333s85.333 38.206 85.333 85.333c0 47.129-38.206 85.333-85.333 85.333-47.129 0-85.333-38.205-85.333-85.333z"
      data-original="#00bcff"
    />
    <path
      fill="#00cf7f"
      d="M85.932 426.667c0-47.128 38.205-85.333 85.333-85.333l45.475-24.009 39.858 24.009v85.333c0 47.129-38.205 85.333-85.333 85.333s-85.333-38.205-85.333-85.333z"
      data-original="#00cf7f"
    />
    <path
      fill="#ff7361"
      d="m256.599 0-46.434 80.67 46.434 89.996h84.136c47.129 0 85.333-38.205 85.333-85.333S387.863 0 340.735 0z"
      data-original="#ff7361"
    />
    <path
      fill="#ff4d12"
      d="M84.734 85.333c0 47.128 38.205 85.333 85.333 85.333l45.267 17.484 41.263-17.484V0h-86.531c-47.127 0-85.332 38.205-85.332 85.333z"
      data-original="#ff4d12"
    />
    <path
      fill="#b659ff"
      d="M85.932 256c0 47.129 38.205 85.333 85.333 85.333h85.333V170.666h-85.333c-47.128 0-85.333 38.206-85.333 85.334z"
      data-original="#b659ff"
    />
  </svg>
);
...
export const InstagramIcon = ({ className, ...rest }) => (
  ...
  export const ReactIcon = (className , ...rest) => (
    ...
    >
      ...
      >
        <stop offset={0} stopColor="#42445a" />
        <stop offset={1} stopColor="#3d3f4a" />
      </linearGradient>
      <path
        d="M49 42c-5 0-9 4-9 9s4 9 9 9 9-4 9-9-4-9-9-9zm0 12c-1.7 0-3-1.3-3-3s1.3-3 3-3 3 1.3 3 3-1.3 3-3 3z"
        className="st1"
        style={{
          fill: "url(#b)",
        }}
...
export const TwitterIcon = ({ className, ...rest }) => (
  <svg
    ...
    viewBox="0 0 256 209"
    {...rest}
    className={`w-full h-8 light:fill-dark ${className}`}
  >
